...
export default function UmkmClientPageSimple({
  allUmkm,
}: UmkmClientPageSimpleProps) {
  ...
  const [sortBy, setSortBy] = useState<
    "default" | "distance-asc" | "distance-desc" | "time-asc" | "time-desc"
  >("default");
  ...
  const allCategories = useMemo(() => {
    return Array.from(
      new Set(umkmWithCoords.map((u) => u.type).filter(Boolean)),
    ).sort();
  }, [umkmWithCoords]);
    ...
    <div className="min-h-screen bg-gray-75">
      ...
      <div className="container mx-auto px-4 py-8">
          ...
          <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
            ...
            <div className="flex-1 w-full lg:w-auto">
              <div className="flex items-center gap-2 mb-3">
                ...
                />
                <h4 className="text-sm font-bold text-[var(--dark)]">
                  Filter Kategori
                </h4>
              </div>
                ...
                {allCategories.map((cat, i) => (
                  ...
                  >
                    <Tag
                      size={16}
                      weight={
                        selectedCategories.includes(cat) ? "fill" : "bold"
                      }
                      className={
                        selectedCategories.includes(cat)
                          ? "text-white"
              ...
              <div className="relative" ref={sortDropdownRef}>
                ...
                >
                  ...
                  <CaretDown
                    size={14}
                    weight="bold"
                    className={`text-gray-500 transition-transform ${showSortDropdown ? "rotate-180" : ""}`}
                  />
                </button>
        ...
        <div>
          ...
          {/* Map View */}
          {activeTab === "tab3" && <MapView allUmkm={filteredUmkm} />}
        </div>
      </div>
