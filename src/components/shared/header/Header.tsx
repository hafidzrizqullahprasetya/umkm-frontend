...
function Header({
  ...
  const filteredUmkm = allUmkm
    .filter((umkm) => {
      ...
      const matchesCategory =
        selectedCategory === "Semua" || umkm.type === selectedCategory;
  ...
  return (
    <>
      <header
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 bg-[var(--primary)] ${isSticky ? "shadow-lg" : ""}`}
      >
              ...
              <div className="flex justify-between items-center py-3 sm:py-4">
                ...
                <div className="hidden md:block flex-1 max-w-2xl mx-4 lg:mx-8">
                  <div className="flex gap-2">
                    {/* Location Badge */}
                    <div
                      className="hidden lg:flex items-center gap-2 px-4 py-2.5 bg-secondary rounded-lg backdrop-blur-sm whitespace-nowrap h-[42px]"
                      data-tour="location"
                    >
                    ...
                    >
                      ...
                      >
                        <Tag
                          size={15}
                          weight="bold"
                          className="text-[var(--primary)] lg:w-4 lg:h-4"
                        />
                        <span className="text-xs lg:text-sm font-medium text-[var(--dark)] max-w-[80px] lg:max-w-none truncate">
                          {selectedCategory}
                        </span>
                        <CaretDown
                          size={12}
                          weight="bold"
                          className="text-gray-500 lg:w-3.5 lg:h-3.5"
                        />
                      </button>
                          ...
                          <button
                            ...
                            className={`w-full px-4 py-2.5 text-left text-sm hover:bg-gray-50 transition-colors flex items-center gap-2 ${
                              selectedCategory === "Semua"
                                ? "bg-[var(--primary)]/5 text-[var(--primary)] font-semibold"
                                : "text-gray-700"
                            }`}
                          >
                            <Tag
                              size={16}
                              weight={
                                selectedCategory === "Semua" ? "fill" : "bold"
                              }
                              className={
                                selectedCategory === "Semua"
                                  ? "text-[var(--primary)]"
                          ...
                          {allCategories.map((cat, i) => (
                            ...
                            >
                              <Tag
                                size={16}
                                weight={
                                  selectedCategory === cat ? "fill" : "bold"
                                }
                                className={
                                  selectedCategory === cat
                                    ? "text-[var(--primary)]"
                            ...
                            <>
                              {filteredUmkm.map((umkm) => (
                                <button
                                  key={umkm.id}
                                  onClick={() =>
                                    handleUmkmClick(umkm.id.toString())
                                  }
                                ...
                                >
                                  <div className="flex items-start gap-3">
                                    ...
                                    <div className="flex-1 min-w-0">
                                      <h4 className="text-sm font-semibold text-[var(--dark)] truncate">
                                        {umkm.name}
                                      </h4>
                                      ...
                                      <span className="inline-block mt-1 px-2 py-0.5 bg-primary text-white text-xs rounded-md font-medium">
                                        {umkm.type}
                                      </span>
                                    </div>
                                  </div>
        ...
        {/* Breadcrumb Section */}
        <div
          className={`bg-gradient-to-r from-white/5 to-white/10 ${!breadcrumbOnly ? "border-t border-white/10" : ""}`}
        >
          <div className="container mx-auto px-4 sm:px-6 py-2.5 sm:py-3">
            <div className="flex items-center gap-2 text-xs sm:text-sm overflow-x-auto">
              ...
              >
                <House
                  size={14}
                  weight={isHomePage ? "fill" : "regular"}
              ...
              {pathname === "/home" && (
                <>
                  <CaretRight
                    size={14}
                    weight="bold"
                    className="text-white/50 flex-shrink-0 sm:w-4 sm:h-4"
                  />
